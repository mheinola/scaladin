...
trait ViewChangeListener extends com.vaadin.navigator.ViewChangeListener with Listener {
  ...
  def afterViewChange(e: com.vaadin.navigator.ViewChangeListener.ViewChangeEvent): Unit = {}
}

class BeforeViewChangeListener(val action: Navigator.ViewChangeEvent => Boolean) extends ViewChangeListener {
  override def beforeViewChange(e: com.vaadin.navigator.ViewChangeListener.ViewChangeEvent): Boolean = action(Navigator.ViewChangeEvent(wrapperFor[Navigator](e.getNavigator()).get, wrapperFor[Navigator.View](e.getOldView()).get, wrapperFor[Navigator.View](e.getNewView()).get, e.getViewName(), e.getParameters()))
}

class AfterViewChangeListener(val action: Navigator.ViewChangeEvent => Unit) extends ViewChangeListener {
  override def afterViewChange(e: com.vaadin.navigator.ViewChangeListener.ViewChangeEvent): Unit = action(Navigator.ViewChangeEvent(wrapperFor[Navigator](e.getNavigator()).get, wrapperFor[Navigator.View](e.getOldView()).get, wrapperFor[Navigator.View](e.getNewView()).get, e.getViewName(), e.getParameters()))
}
