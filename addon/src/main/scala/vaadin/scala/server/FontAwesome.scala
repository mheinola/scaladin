...
object FontAwesome {
  ...
  val AT = FontAwesome(com.vaadin.server.FontAwesome.AT)
  val Asterisk = FontAwesome(ASTERISK)
  val Automobile = FontAwesome(AUTOMOBILE)
  val Backward = FontAwesome(BACKWARD)
  val BalanceScale = FontAwesome(BALANCE_SCALE)
  val Ban = FontAwesome(BAN)
  val Bank = FontAwesome(BANK)
  val BarChart = FontAwesome(BAR_CHART)
  val BarChartO = FontAwesome(BAR_CHART_O)
  val Barcode = FontAwesome(BARCODE)
  val Bars = FontAwesome(BARS)
  val Battery0 = FontAwesome(BATTERY_0)
  val Battery1 = FontAwesome(BATTERY_1)
  val Battery2 = FontAwesome(BATTERY_2)
  val Battery3 = FontAwesome(BATTERY_3)
  val Battery4 = FontAwesome(BATTERY_4)
  val BatteryEmpty = FontAwesome(BATTERY_EMPTY)
  val BatteryFull = FontAwesome(BATTERY_FULL)
  val BatteryHalf = FontAwesome(BATTERY_HALF)
  val BatteryQuarter = FontAwesome(BATTERY_QUARTER)
  val BatteryThreeQuarters = FontAwesome(BATTERY_THREE_QUARTERS)
  val Bed = FontAwesome(BED)
  ...
  val BellSlash = FontAwesome(BELL_SLASH)
  val BellSlashO = FontAwesome(BELL_SLASH_O)
  val Bicycle = FontAwesome(BICYCLE)
  val Binoculars = FontAwesome(BINOCULARS)
  val BirthdayCace = FontAwesome(BIRTHDAY_CAKE)
  val Bitbucket = FontAwesome(BITBUCKET)
  val BitbucketSquare = FontAwesome(BITBUCKET_SQUARE)
  val Bitcoin = FontAwesome(BITCOIN)
  val BlackTie = FontAwesome(BLACK_TIE)
  ...
  val Bus = FontAwesome(BUS)
  val BuySellAds = FontAwesome(BUYSELLADS)
  val Cab = FontAwesome(CAB)
  val Calculator = FontAwesome(CALCULATOR)
  val Calendar = FontAwesome(CALENDAR)
  val CalendarCheckO = FontAwesome(CALENDAR_CHECK_O)
  val CalendarMinusO = FontAwesome(CALENDAR_MINUS_O)
  val CalendarO = FontAwesome(CALENDAR_O)
  val CalendarPlusO = FontAwesome(CALENDAR_PLUS_O)
  val CalendarTimesO = FontAwesome(CALENDAR_TIMES_O)
  ...
  val CartArrowDown = FontAwesome(CART_ARROW_DOWN)
  val CartPlus = FontAwesome(CART_PLUS)
  val CC = FontAwesome(com.vaadin.server.FontAwesome.CC)
  val CCAmex = FontAwesome(CC_AMEX)
  val CCDinersClub = FontAwesome(CC_DINERS_CLUB)
  val CCDiscover = FontAwesome(CC_DISCOVER)
  val CCJCB = FontAwesome(CC_JCB)
  val CCMasterCard = FontAwesome(CC_MASTERCARD)
  val CCPayPal = FontAwesome(CC_PAYPAL)
  val CCStripe = FontAwesome(CC_STRIPE)
  val CCVisa = FontAwesome(CC_VISA)
  ...
  val Commenting = FontAwesome(COMMENTING)
  val CommentingO = FontAwesome(COMMENTING_O)
  ...
  val ConnectDevelop = FontAwesome(CONNECTDEVELOP)
  val Contao = FontAwesome(CONTAO)
  val Copy = FontAwesome(COPY)
  val CopyRight = FontAwesome(COPYRIGHT)
  val CreativeCommons = FontAwesome(CREATIVE_COMMONS)
  ...
  val DashCube = FontAwesome(DASHCUBE)
  ...
  val Diamond = FontAwesome(DIAMOND)
  ...
  val ExpeditedSSL = FontAwesome(EXPEDITEDSSL)
  ...
  val Eyedropper = FontAwesome(EYEDROPPER)
  val Facebook = FontAwesome(FACEBOOK)
  val FacebookF = FontAwesome(FACEBOOK_F)
  val FacebookOfficial = FontAwesome(FACEBOOK_OFFICIAL)
